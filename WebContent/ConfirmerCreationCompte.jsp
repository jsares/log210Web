<jsp:include page="header.jsp"/>
  <div class="top_message">
    <h4 class="text-center" id="CompteSucces">Le compte a été créé avec succès ! Vous pouvez maintenant vous identifier ci-dessous.</h4>
</div>
    ...
    <div class="v-center">
        ...
        <div class="text-center">
            ...
            <div class="btn-group">
                ...
                <li><a href="#" data-toggle="modal" data-target="#modalLogInEtudiant">Log in</a></li>
                <li><a href="#" data-toggle="modal" data-target="#modalSignUpEtudiant">Sign Up</a></li>
              </ul>
            </div>&nbsp;
            <div class="btn-group">
                        <button type="button" class="btn btn-danger btn-lg btn-huge lato dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 ...
                 <ul class="dropdown-menu">
                <li><a href="#" data-toggle="modal" data-target="#modalLogInGestionnaire">Log in</a></li>
                <li><a href="#" data-toggle="modal" data-target="#modalSignUpGestionnaire">Sign Up</a></li>
              </ul>
            </div>
          </div>
</div>

...
<form>
	<a href="CreationCEtudiant.html"> <input type="button"
		value="Créer un compte étudiant" name="Submit" id="frm_submit" />
	</a> <br> <br> 
	<a href="CreationGestionnaire.html"> <input type="button"
		value="Créer un compte gestionnaire" name="Submit" id="frm_submit" />
	</a> <br> <br> 	
	<a href="LoginEtudiant.html"> <input type="button"
		value="Log in un compte étudiant" name="Submit" id="frm_submit" />
	</a> <br> <br> 
	<a href="LoginGestionnaire.html"> <input type="button"
